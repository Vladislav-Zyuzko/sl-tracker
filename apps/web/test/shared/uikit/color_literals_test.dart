...
const _allowed = <String, String>{
  ...
  // Единственное задокументированное исключение из системы: оба варианта
  // цвета кнопки заданы Яндексом, роли системы к ней не применяются
  // (`system.md`, 3.4.1). Схема выбирает вариант, но не красит кнопку.
  'lib/shared/uikit/buttons/yandex_id_button.dart': 'бренд Яндекс ID',
  // Тени: в светлой схеме `#26395B` с альфами из спеки, в тёмной чистый
  // чёрный с втрое большей альфой (`system.md`, 10.7). Это тот же слой 2,
  // что и роли цвета, только для теней.
  'lib/shared/uikit/sl_shadows.dart': 'тени обеих схем',
