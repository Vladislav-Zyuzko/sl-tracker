...
@JsonEnum()
enum NotificationSettingDtoType {
  ...
  const NotificationSettingDtoType(this.json);

  factory NotificationSettingDtoType.fromJson(String json) =>
  ...
  static List<NotificationSettingDtoType> get $valuesDefined =>
