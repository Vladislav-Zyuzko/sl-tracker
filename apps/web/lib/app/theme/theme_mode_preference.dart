...
///
/// Значение по умолчанию — [ThemeMode.system] (`system.md`, 12.5):
/// большинство ничего не настраивает и ожидает, что приложение подстроится
/// само, а явный выбор нужен тому, у кого ОС тёмная, а монитор стоит
/// в светлой комнате.
